...
const industries = [
  {
    ...
    description: "Weighing scales and systems help transportation and logistics companies move freight quickly, safely and efficiently.",
    href: "/shop?industry=logistics",
  ...
  },
  {
    icon: Factory,
    name: "Manufacturing",
    description: "Our scales and systems help manufacturing companies measure inputs, collect and analyze data and monitor waste to be as efficient and lean as possible.",
    href: "/shop?industry=manufacturing",
  ...
  },
  {
    ...
    description: "Truck scales and weighing systems provide critical weight information to the global mining and aggregate industries.",
  ...
  },
  {
    ...
    description: "Deli scales, price computing scales, and label printing solutions for retail and commercial applications.",
  ...
  },
  {
    icon: Gem,
    name: "Infrastructure",
    description: "Weighing scales and systems help measure and record incoming materials and outgoing waste to identify operational inefficiencies.",
    href: "/shop?industry=infrastructure",
  ...
  },
  {
    ...
    description: "Weighing scales and systems for medical, hospitals, utilities, engineering, public sector, defence and many more.",
    href: "/shop?industry=other",
